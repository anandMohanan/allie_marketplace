  ...
  const J = [
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      function i(t, s) {
        ...
        const i = a.renderSlide
          ...
          : d(
              `<div className="${e.params.slideClass}" data-swiper-slide-index="${s}">${t}</div>`
            );
        return (
        ...
        if ("bullets" === t.type) {
          ...
          for (let s = 0; s < a; s += 1)
            t.renderBullet
              ...
              : (r += `<${t.bulletElement} className="${t.bulletClass}"></${t.bulletElement}>`);
          i.html(r), (e.pagination.bullets = i.find(W(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
            ? t.renderFraction.call(e, t.currentClass, t.totalClass)
            : `<span className="${t.currentClass}"></span> / <span className="${t.totalClass}"></span>`),
          i.html(r)),
          "progressbar" === t.type &&
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function T() {
        ...
        0 === r.length &&
          ((r = d(`<div className="${e.params.scrollbar.dragClass}"></div>`)),
          i.append(r)),
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      s("beforeInit", () => {
        a = d(
          `<span className="${e.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`
        );
      }),
        s("afterInit", () => {
            ...
            c.shadow &&
              (p
                ? ((h = s.find(".swiper-cube-shadow")),
                  0 === h.length &&
                    ((h = d('<div className="swiper-cube-shadow"></div>')),
                    s.append(h)),
                  h.css({ height: `${i}px` }))
